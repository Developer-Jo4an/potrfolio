...
export const DUNK_SHOT_STATE_MACHINE = {
  [INITIALIZATION]: {availableStates: [INIT_LEVEL], nextState: INIT_LEVEL, isDefault: true, isLoad: true},
  [INIT_LEVEL]: {availableStates: [PREPARE], nextState: PREPARE, isLoad: true},
  ...
  [WINGS]: {availableStates: [PLAYING, WIN], isAvailableCameraUpdate: true, isAvailableUpdate: true},
  [FELL]: {
