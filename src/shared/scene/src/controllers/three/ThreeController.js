...
export class ThreeController extends BaseController {
  DECORATORS = [
  ...
  async loadAssets() {
    ...
    if (preload) {
      ...
      await ThreeController.loader.init(storage.preload);
      await ThreeController.loader.loadAssets(storage.preload);
    }
  }
