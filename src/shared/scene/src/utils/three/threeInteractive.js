...
const {Raycaster: a, Vector2: h} = THREE;
  ...
  u = class {
    ...
    constructor(e, s, t, n) {
      (this.renderer = e),
        (this.camera = s),
        (this.domElement = t),
        (this.bindEventsOnBodyElement = !0),
        typeof n < "u" && n && (this.bindEventsOnBodyElement = !1),
        (this.mouse = new h(-1, 1)),
        (this.supportsPointerEvents = !!window.PointerEvent),
        (this.interactiveObjects = []),
        (this.closestObject = null),
        (this.raycaster = new a()),
        t.addEventListener("click", this.onMouseClick),
        this.supportsPointerEvents
          ? (this.bindEventsOnBodyElement
              ? t.ownerDocument.addEventListener("pointermove", this.onDocumentMouseMove)
              : t.addEventListener("pointermove", this.onDocumentMouseMove),
            t.addEventListener("pointerdown", this.onMouseDown),
            t.addEventListener("pointerup", this.onMouseUp))
          : (this.bindEventsOnBodyElement
