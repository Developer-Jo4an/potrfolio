...
export const useDunkShotStars = () => {
  ...
  return (stars, from, to) => {
    ...
    stars.forEach(starsGroup => {
      starsGroup.forEach(star => gsap.set(star, {
        x: 0, y: 0,
        rotate: 0,
    ...
    stars.forEach((starsGroup, groupIndex) => {
      starsGroup.forEach((star, starIndex, {length: groupLength}) => {
        ...
        startsTween.to(star, {
          ...
          duration: 0.2,
          ease: "none"
        }, groupIndex * delay.betweenGroups + starIndex * delay.betweenStars).to(
          star,
          {
            motionPath: {
          ...
          duration: 0.6,
          ease: "none"
        }, groupIndex * delay.betweenGroups);
      });
    });
  };
};
